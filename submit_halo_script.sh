...
#SBATCH -o ./batch_files/patchy_screening_logs/job.halo_%J.dump
#SBATCH -e ./batch_files/patchy_screening_logs/job.halo_%J.err
#SBATCH -p cosma8
#SBATCH -A dp004
...
python3 $PYTHON_SCRIPT $SLURM_CPUS_PER_TASK "$@" halo "$RUN_ID" false
